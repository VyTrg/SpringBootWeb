		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="row">
				...
				<div class="col-sm-10 mt-4">
					<form:form action="/admin/themnv" modelAttribute="nv"
							...
							<div class="row mt-3 mb-3">
								<div class="col-md-6">
									<div class="form-group">
										...
										<form:input path="ma_nhan_vien" class="form-control" />
										<form:errors path="ma_nhan_vien" cssClass="text-danger" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<form:select path="phongBan.ma_phong_ban" class="form-control"
											style="width: 50%">
											<form:options items="${pb}" itemValue="ma_phong_ban"
												itemLabel="ten_phong_ban" />
										</form:select>
										<form:errors path="phongBan.ma_phong_ban"
							...
							<div class="row mt-3 mb-3">
								...
								<div class="form-group">
									...
									<form:input path="dangNhap.Quyen.ma_quyen" class="form-control"
										style="width: 50%" value="NV" readonly="true" />
