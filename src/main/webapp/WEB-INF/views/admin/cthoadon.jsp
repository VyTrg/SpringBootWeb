									  ...
									  <div class="mb-4 px-4">
										<div class="card-body">
										  <div class="row">
											...
											<div class="col-sm-9">
											  <p class="text-muted mb-0">${thongtinhoadon.nhanVien.ma_nhan_vien}</p>
											</div>
										  </div>
										  <hr>
										  <div class="row">
											...
											<div class="col-sm-9">
											  <p class="text-muted mb-0">${thongtinhoadon.nhanVien.ho_ten}</p>
											</div>
										  </div>
										  <hr>
										  <div class="row">
											...
											<div class="col-sm-9">
											  <p class="text-muted mb-0">${thongtinhoadon.nhanVien.sdt}</p>
											</div>
										  </div>
										  <hr>
										  <div class="row">
											...
											<div class="col-sm-9">
											  <p class="text-muted mb-0">${thongtinhoadon.nhanVien.cccd}</p>
											</div>
										  </div>
											<hr class="mt-4	mr-2">
										  <div class="row">
											...
											<table class="table table-striped">
												...
												<c:forEach var="p" items="${chitiethoadon}">
													<tr id="${p.get("ma_dich_vu")}">
														<td>${count}</td>
														<td>${p.get("ma_dich_vu")}</td>
														<td>${p.get("ten_dich_vu")}</td>
														<td>${p.get("vat")}</td>
														<td>${p.get("don_gia")}</td>
														<td>${p.get("don_vi")}</td>
														<td>
															<input type="text" class="form-control" name="dichvu" value="${p.get("so_luong")}" readonly="true">
														<td>${p.get("tong")}</td>
													</tr>
