                                    ...
                                    <table class="table table-bordered dataTable table-hover js-table" id="dataTable" width="100%" cellspacing="0" role="grid"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                                    aria-label="Salary: activate to sort column ascending" style="width: 100px;">Người lập</th>
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                        ...
                                        <c:forEach var="i" items="${danhSachHoaDon}">
                                                <tr>
                                                    ...
                                                    <td>${i.tien_thang}</td>
                                                    <td>
                                                    <button type="button" class="btn btn-primary btn_chitiethoadon" data-bs-toggle="modal" data-bs-target="#chitietModal"> Xem chi tiết</button>
                                                    ...
                                                    data-tenhoadon="${i.tenHoaDon}" data-canho="${i.maCanHo.ma_can_ho}">Thanh toán</button>
