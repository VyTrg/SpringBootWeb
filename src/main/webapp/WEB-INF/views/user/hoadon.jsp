      ...
      <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
        ...
        <head>
          ...
          <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js"
            ...
            crossorigin="anonymous"></script>
          <script src="../../../static/js/user_hoadon.js"></script>
        ...
        <body>
                    ...
                    <div class="card-body">
                      <div class="table">
                        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                          <div class="row">
                            <div class="col-sm-12">
                              <table class="table table-bordered dataTable table-hover js-table" id="dataTable"
                                ...
                                <thead>
                                  <tr role="row">
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1"
                                      ...
                                      aria-label="Name: activate to sort column descending" style="width: 10px;">STT
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                      aria-label="Position: activate to sort column ascending"
                                      style="width: 150.111px;">Tên
                                      hoá đơn</th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                      aria-label="Position: activate to sort column ascending"
                                      style="width: 150.111px;">Mã
                                      căn hộ</th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                      aria-label="Office: activate to sort column ascending" style="width: 100px;">Ngày
                                      lập
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                      aria-label="Salary: activate to sort column ascending" style="width: 100px;">Người
                                      lập
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"
                                      aria-label="Salary: activate to sort column ascending" style="width: 100px;">Tổng
                                      tiền
                                    </th>
                                ...
                                <tbody>
                                  ...
                                  <c:forEach var="i" items="${danhSachHoaDon}">
                                    <tr>
                                      <td style="display:none;">${i.ma_hoa_don}</td>
                                      ...
                                      <td>
                                        ...
                                        <button type="button" class="btn btn-primary btn_chitiethoadon"
                                          data-bs-toggle="modal" data-bs-target="#chitietModal-${fn:trim(i.ma_hoa_don)}"
                                          data-chitiet="${i.ma_hoa_don}.trim()" data-csh="${thongtin.ma_chu_so_huu}"
                                          data-idcanho="${i.maCanHo.ma_can_ho}">Xem chi tiết</button>
                                        <div class="modal fade" id="chitietModal-${fn:trim(i.ma_hoa_don)}" tabindex="-1"
                                      ...
                                      <td>
                                        <button type="button" class="btn btn-primary btn_thanhtoan"
                                          data-bs-toggle="modal" data-bs-target="#thanhtoanModal"
                                          data-tenhoadon="${i.tenHoaDon}" data-canho="${i.maCanHo.ma_can_ho}"
                                          data-mahoadon="${i.ma_hoa_don}">Thanh
                                          toán</button>
                                        <input type="hidden" name="ip_ma_hoa_don" id="ip_ma_can_ho"
                                          value="${i.ma_hoa_don}">
                                        <div class="modal fade" id="thanhtoanModal" tabindex="-1"
                                          aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              <form action="/user/thanhtoan" method="post">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <button type="button" class="btn btn-secondary btn_xacnhan"
                                                    data-bs-dismiss="modal" data-khachhang="${thongtin.ma_chu_so_huu}"
                                                    id="xacnhan">Xác nhận</button>
                                                </div>
                                              </form>
                                            </div>
                                          </div>
          ...
          <script type="text/javascript">
            var btn_chitiets = document.querySelectorAll('.btn_chitiethoadon');
            btn_chitiets.forEach(function (btn_chitiet) {
              btn_chitiet.addEventListener('click', function () {
                var id_hoa_don = btn_chitiet.getAttribute('data-chitiet').trim();
                var id_csh = btn_chitiet.getAttribute('data-csh').trim();
                var id_ch = btn_chitiet.getAttribute('data-idcanho').trim();
                ...
                //   },
                //   type: "GET",
                //   url: "http://localhost:8080/user/hoadon/find/" + id_ch,
                //   success: function success() {
                //     // alert(id_ch, id_csh);
                //     // var ds_hoadon = '${chitiethd}.get(0).get("ten_dich_vu")';
                //     // console.log(ds_hoadon);
                //   },
            ...
            btn_thanhtoans.forEach(function (btn_thanhtoan) {
              btn_thanhtoan.addEventListener('click', function () {
                ...
                $('#xacnhan').attr("data-hoadon", btn_thanhtoan.getAttribute('data-mahoadon'));
              })
            })
            ...
            btn_xacnhans.forEach(function (btn_xacnhan) {
              btn_xacnhan.addEventListener('click', function Thanhtoan() {
                $.ajax({
                  url: "http://localhost:8080/user/thanhtoan",
                  type: "POST",
            ...
            const ds_hoadon = '${danhSachHoaDon}';
            console.log(ds_hoadon);
          </script>
